...
export const GlassPane = (nonDefaultProps: PropsWithChildren<GlassPaneProps>) => {
    ...
    const paneWarpMap = <SVGPaneWarpMap width={props.width + 40} height={props.height + 40} edgeSize={props.edgeSize} edgeInset={props.edgeInset} />;
    ...
    return <>
        ...
        <div
            ...
            style={{
                //saturate(110%) contrast(120%) brightness(90%)
                backdropFilter: `saturate(110%) contrast(${props.contrast}%) brightness(${props.brightness}%) blur(${props.overallBlur}px) url(#${panelWarpFilterId})`,
                height: props.height,
                width: props.width
            }}
        >
