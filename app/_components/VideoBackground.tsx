...
export const VideoBackground = () => {
    ...
    return (
        <>
            <div
                className={
                    "fixed top-0 left-0 right-0 bottom-0 min-w-full min-h-full aspect-video select-none pointer-events-none z-0"
                }
                style={{
                    backgroundImage:
                        "url('https://z8h06o6ier.ufs.sh/f/iw5UBfcnzDy0lQeyYZR5H10PTOos8NUJMgrxfv963BVi2GEk')",
